...
copy ..\..\..\..\cyclone_tcp\mqtt\*.c main\cyclone_tcp\mqtt
copy ..\..\..\..\cyclone_tcp\web_socket\*.c main\cyclone_tcp\web_socket
...
copy ..\..\..\..\cyclone_tcp\mqtt\*.h main\cyclone_tcp\mqtt
