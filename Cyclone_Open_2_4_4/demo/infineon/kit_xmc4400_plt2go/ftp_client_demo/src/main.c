...
#define APP_MAC_ADDR "00-AB-CD-EF-44-00"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::4400"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::4400"
...
void ioInit(void)
{
   ...
   //Configure P0.6 and P0.7 as general purpose outputs
   temp = PORT0->IOCR4;
   temp &= ~(PORT0_IOCR4_PC6_Msk | PORT0_IOCR4_PC7_Msk);
   temp |= (16UL << PORT0_IOCR4_PC6_Pos) | (16UL << PORT0_IOCR4_PC7_Pos);
   PORT0->IOCR4 = temp;

   //Select the output driver strength
   temp = PORT0->PDR0;
   temp &= ~(PORT0_PDR0_PD6_Msk | PORT0_PDR0_PD7_Msk);
   temp |= (2UL << PORT0_PDR0_PD6_Pos) | (2UL << PORT0_PDR0_PD7_Pos);
   PORT0->PDR0 = temp;

   //Configure P3.1 and P3.2 as general purpose inputs
   temp = PORT3->IOCR0;
   temp &= ~(PORT3_IOCR0_PC1_Msk | PORT3_IOCR0_PC2_Msk);
   temp |= (0UL << PORT3_IOCR0_PC1_Pos) | (0UL << PORT3_IOCR0_PC2_Pos);
   PORT3->IOCR0 = temp;
}
...
int_t main(void)
{
   ...
   netSetDriver(interface, &xmc4400EthDriver);
