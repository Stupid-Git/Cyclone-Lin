...
#define APP_MAC_ADDR "00-AB-CD-EF-11-10"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::1110"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::1110"
...
void ioInit(void)
{
   ...
   HAL_GPIO_Init(LED_G_GPIO, &GPIO_InitStructure);
   ...
   GPIO_InitStructure.Pull = GPIO_NOPULL;
   GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_LOW;
   HAL_GPIO_Init(LED_R_GPIO, &GPIO_InitStructure);

   //Configure yellow LED
   GPIO_InitStructure.Pin = LED_Y_PIN;
   GPIO_InitStructure.Mode = GPIO_MODE_OUTPUT_PP;
   GPIO_InitStructure.Pull = GPIO_NOPULL;
   GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_LOW;
   HAL_GPIO_Init(LED_Y_GPIO, &GPIO_InitStructure);
   ...
   GPIO_InitStructure.Pull = GPIO_NOPULL;
   GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_LOW;
   HAL_GPIO_Init(LED_B_GPIO, &GPIO_InitStructure);

   //Clear LEDs
   HAL_GPIO_WritePin(LED_G_GPIO, LED_G_PIN, GPIO_PIN_SET);
   HAL_GPIO_WritePin(LED_R_GPIO, LED_R_PIN, GPIO_PIN_SET);
   HAL_GPIO_WritePin(LED_Y_GPIO, LED_Y_PIN, GPIO_PIN_SET);
   HAL_GPIO_WritePin(LED_B_GPIO, LED_B_PIN, GPIO_PIN_SET);
...
int_t main(void)
{
   ...
   netSetDriver(interface, &adin1110Driver);
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "EVAL-ADIN1110EBZ");
   }
