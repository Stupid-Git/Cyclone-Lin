...
#define APP_MAC_ADDR "00-AB-CD-EF-04-70"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::470"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::470"
...
int_t main(void)
{
   ...
   netSetDriver(interface, &gd32f4xxEthDriver);
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "GD32F470Z-EVAL");
   }
