...
#define APP_MAC_ADDR "00-AB-CD-EF-05-07"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::507"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::507"
...
void userTask(void *param)
{
   ...
   {
      //User button pressed?
      if(!gd_eval_key_state_get(KEY_CET))
      {
         //SCP client test routine
         scpClientTest();

         //Wait for the user button to be released
         while(!gd_eval_key_state_get(KEY_CET));
      }
...
int_t main(void)
{
   ...
   netSetDriver(interface, &gd32e5xxEthDriver);
