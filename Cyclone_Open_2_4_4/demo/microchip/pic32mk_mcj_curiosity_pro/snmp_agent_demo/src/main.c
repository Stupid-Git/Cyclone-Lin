...
#include "pic32mk_mcj_curiosity_pro.h"
#include "core/net.h"
...
#define APP_MAC_ADDR "00-AB-CD-EF-05-12"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::512"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::512"
...
/**
 * @brief External 3 interrupt service routine
 **/

void __ISR(_EXTERNAL_3_VECTOR, IPL2SRS) ext3IrqWrapper(void)
{
...
void ioInit(void)
{
   ...
   //Configure KSZ8851 CS (RD8)
   TRISDCLR = _TRISD_TRISD8_MASK;
   //Deassert CS
   LATDSET = _LATD_LATD8_MASK;

   //Configure KSZ8851 RST (AN19/RG6)
   TRISGCLR = _TRISG_TRISG6_MASK;
   //Disable analog pad
   ANSELGCLR = _ANSELG_ANSG6_MASK;

   //Reset KSZ8851 Ethernet controller
   LATGCLR = _LATG_LATG6_MASK;
   sleep(100);
   LATGSET = _LATG_LATG6_MASK;
   sleep(100);
}
...
int_t main(void)
{
   ...
   TRACE_INFO("Target: PIC32MK0512MCJ064\r\n");
   TRACE_INFO("\r\n");
