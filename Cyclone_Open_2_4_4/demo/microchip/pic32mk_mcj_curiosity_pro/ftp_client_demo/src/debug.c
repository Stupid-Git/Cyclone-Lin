...
{
#if 0
   //Disable analog pad on U1TX (AN40/RE0)
   ANSELECLR = _ANSELE_ANSE0_MASK;
   //Disable analog pad on U1RX (AN17/RG8)
...
#else
   //Disable analog pad on U2TX (AN16/RG9)
   ANSELGCLR = _ANSELG_ANSG9_MASK;
   //Disable analog pad on U2RX (AN46/RA14)
   ANSELACLR = _ANSELA_ANSA14_MASK;
