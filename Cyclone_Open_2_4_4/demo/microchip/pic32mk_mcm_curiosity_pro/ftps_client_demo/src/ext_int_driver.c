...
{
   //Enable pull-up on INT2 (RD4)
   CNPUDSET = _CNPUD_CNPUD4_MASK;
   ...
   IPC3CLR = _IPC3_INT2IP_MASK;
   IPC3SET = (2 << _IPC3_INT2IP_POSITION);

   //Set interrupt subpriority
   IPC3CLR = _IPC3_INT2IS_MASK;
   IPC3SET = (0 << _IPC3_INT2IS_POSITION);
