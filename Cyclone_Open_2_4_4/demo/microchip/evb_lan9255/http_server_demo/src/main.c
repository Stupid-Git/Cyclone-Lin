...
#define APP_MAC_ADDR "00-AB-CD-EF-92-55"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::9255"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::9255"
...
void ioInit(void)
{
   ...
   PORT_REGS->GROUP[LED2_GROUP].PORT_OUTCLR = LED2_MASK;

   //Configure LED3
   PORT_REGS->GROUP[LED3_GROUP].PORT_DIRSET = LED3_MASK;
   PORT_REGS->GROUP[LED3_GROUP].PORT_OUTCLR = LED3_MASK;

   //Configure LED4
   PORT_REGS->GROUP[LED4_GROUP].PORT_DIRSET = LED4_MASK;
   PORT_REGS->GROUP[LED4_GROUP].PORT_OUTCLR = LED4_MASK;
}
...
int_t main(void)
{
   ...
   netSetDriver(interface, &same53EthDriver);
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "EVB-LAN9255");
   }
