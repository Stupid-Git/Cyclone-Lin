...
{
#if 0
   //Remap U2TX to RC6/RP23
   RPOR5bits.RP23R = 4;
   //Remap U2RX to RC7/RP20
   RPINR9bits.U2RXR = 20;
...
#else
   //Disable analog pad on U2RX (AN19/RA6)
   ANSELACLR = _ANSELA_ANSA6_MASK;
