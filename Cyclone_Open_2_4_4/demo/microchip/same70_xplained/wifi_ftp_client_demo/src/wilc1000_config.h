...
//SPI instance
#define CONF_WILC_SPI         SPI0_REGS
#define CONF_WILC_SPI_ID      ID_SPI0
#define CONF_WILC_SPI_PIO     PIOD_REGS
#define CONF_WILC_SPI_ID_PIO  ID_PIOD

//SPI clock
#define CONF_WILC_SPI_CLOCK   24000000
