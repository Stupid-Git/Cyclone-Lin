...
#define APP_AUTHENTICATOR_NUM_PORTS 5
...
int_t main(void)
{
   ...
   authenticatorSetPortControl(&authenticatorContext, 4, AUTHENTICATOR_PORT_MODE_AUTO);
   authenticatorSetPortControl(&authenticatorContext, 5, AUTHENTICATOR_PORT_MODE_FORCE_AUTH);
