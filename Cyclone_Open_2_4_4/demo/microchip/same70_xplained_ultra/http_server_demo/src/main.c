...
#define APP_IF1_MAC_ADDR "00-AB-CD-70-21-01"
...
#define APP_IF1_IPV6_GLOBAL_ADDR "2001:db8::7021:1"
...
#define APP_IF2_MAC_ADDR "00-AB-CD-70-21-02"
...
#define APP_IF2_IPV6_GLOBAL_ADDR "2001:db8::7021:2"
...
#if defined(USE_KSZ8863) || defined(USE_LAN9303)
...
error_t eth1InterfaceInit(void)
{
   ...
   netSetSwitchPort(interface, KSZ8863_PORT1);
...
error_t eth2InterfaceInit(void)
{
   ...
   //Enable tail tagging mode
   netSetSwitchPort(interface, KSZ8863_PORT2);
#elif defined(USE_LAN9303)
   //Enable special VLAN tagging mode
   netSetSwitchPort(interface, LAN9303_PORT2);
#endif
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "SAME70-Xplained-Ultra");
   }
