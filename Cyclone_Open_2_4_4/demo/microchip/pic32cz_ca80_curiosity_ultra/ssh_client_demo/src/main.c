...
#include <stdlib.h>
#include "pic32c.h"
#include "pic32cz_ca80_curiosity_ultra.h"
#include "core/net.h"
...
#define APP_MAC_ADDR "00-AB-CD-EF-32-80"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::3280"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::3280"
...
void mpuConfig(void)
{
   ...
   MPU->RASR = (0 << MPU_RASR_XN_Pos) | //Instruction fetches enabled
      ...
      (19 << MPU_RASR_SIZE_Pos) |       //Region size (1MB)
...
void ioInit(void)
{
   ...
   PORT_REGS->GROUP[SW1_GROUP].PORT_PINCFG[SW1_PIN] |= PORT_PINCFG_INEN_Msk;
}
...
void userTask(void *param)
{
   ...
   {
      //SW0 button pressed?
      if(!(PORT_REGS->GROUP[SW0_GROUP].PORT_IN & SW0_MASK))
      {
         //Shell client test routine
         shellClientTest();

         //Wait for the SW0 button to be released
         while(!(PORT_REGS->GROUP[SW0_GROUP].PORT_IN & SW0_MASK));
      }
...
int_t main(void)
{
   ...
   TRACE_INFO("Target: PIC32CZ8110CA80208\r\n");
   TRACE_INFO("\r\n");
   ...
   netSetDriver(interface, &pic32czEthDriver);
