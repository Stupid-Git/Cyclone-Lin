...
const uint32_t vectorTable[153] =
{
   ...
   (uint32_t) 0,                     // 70 Reserved
   (uint32_t) 0,                     // 71 Reserved
   (uint32_t) 0,                     // 72 Reserved
   (uint32_t) 0,                     // 73 Reserved
   (uint32_t) 0,                     // 74 Reserved
   (uint32_t) 0,                     // 75 Reserved
   (uint32_t) 0,                     // 76 Reserved
   ...
   (uint32_t) 0,                     // 113 Reserved
   (uint32_t) 0,                     // 114 Reserved
