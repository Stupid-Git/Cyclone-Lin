...
#include <stdlib.h>
#include "sam.h"
#include "same51_curiosity_nano.h"
#include "core/net.h"
...
void ioInit(void)
{
   ...
   PORT_REGS->GROUP[SW0_GROUP].PORT_OUTSET = SW0_MASK;
   PORT_REGS->GROUP[SW0_GROUP].PORT_PINCFG[SW0_PIN] |= PORT_PINCFG_PULLEN_Msk;
   PORT_REGS->GROUP[SW0_GROUP].PORT_PINCFG[SW0_PIN] |= PORT_PINCFG_INEN_Msk;

   //Configure LAN9250 CS pin (PA18)
   ...
   //Configure LAN9250 RST pin (PA7)
   PORT_REGS->GROUP[0].PORT_PINCFG[7] |= PORT_PINCFG_DRVSTR_Msk;
