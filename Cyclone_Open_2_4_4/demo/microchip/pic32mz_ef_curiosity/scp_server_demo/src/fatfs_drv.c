...
#define CS_SETOUT() TRISDCLR = _TRISD_TRISD4_MASK
#define CS_LOW()  LATDCLR = _LATD_LATD4_MASK	/* MMC CS = L */
#define CS_HIGH() LATDSET = _LATD_LATD4_MASK	/* MMC CS = H */
...
#define	FCLK_SLOW()	SPI1BRG = 64		/* Set slow clock (100k-400k) */
#define	FCLK_FAST()	SPI1BRG = 2		/* Set fast clock (depends on the CSD) */
