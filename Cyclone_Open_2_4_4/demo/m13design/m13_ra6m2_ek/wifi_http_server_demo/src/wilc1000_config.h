...
//RST pin (P5_8)
#define CONF_WILC_RST_MASK      (1 << 8)
#define CONF_WILC_RST_PORT      R_PORT5
#define CONF_WILC_RST_PFS       PORT[5].PIN[8].PmnPFS
...
//CS pin (P7_11)
#define CONF_WILC_CS_MASK       (1 << 11)
#define CONF_WILC_CS_PORT       R_PORT7
#define CONF_WILC_CS_PFS        PORT[7].PIN[11].PmnPFS
...
//SPI instance
#define CONF_WILC_SPI           R_SPI1
#define CONF_WILC_SPI_MSTPCR    MSTPCRB
#define CONF_WILC_SPI_MSTP_MASK (R_MSTP_MSTPCRB_MSTPB_Msk << 18)
