...
void adcInit(void)
{
   ...
   //Configure P003/AN007 as an analog input
   R_PFS->PORT[0].PIN[3].PmnPFS = R_PFS_PORT_PIN_PmnPFS_ASEL_Msk;
   ...
   R_ADC0->ADPGADCR0 = 0;
   //Select AN007 channel
   R_ADC0->ADANSA[0] = R_ADC0_ADANSA_ANSA_Msk << 7;
}
