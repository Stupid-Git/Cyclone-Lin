...
void AGT4_INT_IRQHandler               (void) __attribute__((weak, alias("Default_Handler")));
void AGT4_COMPARE_A_IRQHandler         (void) __attribute__((weak, alias("Default_Handler")));
void AGT4_COMPARE_B_IRQHandler         (void) __attribute__((weak, alias("Default_Handler")));
...
void CAN_RXF_IRQHandler                (void) __attribute__((weak, alias("Default_Handler")));
void CAN_GLERR_IRQHandler              (void) __attribute__((weak, alias("Default_Handler")));
void CAN_DMAREQ0_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN_DMAREQ1_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN_DMAREQ2_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN_DMAREQ3_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN_DMAREQ4_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN_DMAREQ5_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN_DMAREQ6_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN_DMAREQ7_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN0_TX_IRQHandler                (void) __attribute__((weak, alias("Default_Handler")));
void CAN0_CHERR_IRQHandler             (void) __attribute__((weak, alias("Default_Handler")));
void CAN0_COMFRX_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN0_CF_DMAREQ_IRQHandler         (void) __attribute__((weak, alias("Default_Handler")));
void CAN1_TX_IRQHandler                (void) __attribute__((weak, alias("Default_Handler")));
void CAN1_CHERR_IRQHandler             (void) __attribute__((weak, alias("Default_Handler")));
void CAN1_COMFRX_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void CAN1_CF_DMAREQ_IRQHandler         (void) __attribute__((weak, alias("Default_Handler")));
...
void CEC_INTDA_IRQHandler              (void) __attribute__((weak, alias("Default_Handler")));
void CEC_INTCE_IRQHandler              (void) __attribute__((weak, alias("Default_Handler")));
void CEC_INTERR_IRQHandler             (void) __attribute__((weak, alias("Default_Handler")));
...
void GPT0_PC_IRQHandler                (void) __attribute__((weak, alias("Default_Handler")));
...
void GPT6_PC_IRQHandler                (void) __attribute__((weak, alias("Default_Handler")));
...
void SCIX0_SCIX0_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void SCIX0_SCIX1_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void SCIX0_SCIX2_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void SCIX0_SCIX3_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void SCIX1_SCIX0_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void SCIX1_SCIX1_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void SCIX1_SCIX2_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
void SCIX1_SCIX3_IRQHandler            (void) __attribute__((weak, alias("Default_Handler")));
...
void CAN_AFLRAM0_ERI_IRQHandler        (void) __attribute__((weak, alias("Default_Handler")));
void CAN_AFLRAM1_ERI_IRQHandler        (void) __attribute__((weak, alias("Default_Handler")));
void CAN_MRAM_ERI_IRQHandler           (void) __attribute__((weak, alias("Default_Handler")));
void OSPI_INT_IRQHandler               (void) __attribute__((weak, alias("Default_Handler")));
...
const uint32_t vectorTable[320] =
{
   ...
   (uint32_t) CEC_INTDA_IRQHandler,
#endif
#if (BSP_IRQ_CFG_CEC_INTCE != BSP_IRQ_DISABLED)
   (uint32_t) CEC_INTCE_IRQHandler,
#endif
#if (BSP_IRQ_CFG_CEC_INTERR != BSP_IRQ_DISABLED)
   (uint32_t) CEC_INTERR_IRQHandler,
#endif
   ...
   (uint32_t) CAN_AFLRAM0_ERI_IRQHandler,
#endif
#if (BSP_IRQ_CFG_CAN_AFLRAM1_ERI != BSP_IRQ_DISABLED)
   (uint32_t) CAN_AFLRAM1_ERI_IRQHandler,
#endif
#if (BSP_IRQ_CFG_CAN_MRAM_ERI != BSP_IRQ_DISABLED)
   (uint32_t) CAN_MRAM_ERI_IRQHandler,
#endif
