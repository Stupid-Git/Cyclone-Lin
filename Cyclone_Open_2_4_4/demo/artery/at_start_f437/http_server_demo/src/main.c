...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::437"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::437"
...
int_t main(void)
{
   ...
   netSetDriver(interface, &at32f4xxEthDriver);
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "AT-START-F437");
   }
