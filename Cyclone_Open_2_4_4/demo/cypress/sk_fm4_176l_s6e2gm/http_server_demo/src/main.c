...
#define APP_MAC_ADDR "00-AB-CD-EF-04-E2"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::4e2"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::4e2"
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "SK-FM4-176L-S6E2GM");
   }
