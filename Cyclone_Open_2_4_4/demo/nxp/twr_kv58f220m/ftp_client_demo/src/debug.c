...
void debugInit(uint32_t baudrate)
{
   ...
   portPinConfig.mux = kPORT_MuxAlt7;
   portPinConfig.lockRegister = kPORT_UnlockRegister;
   PORT_SetPinConfig(PORTB, 0, &portPinConfig);

   //Configure UART0_TX (PORTB1)
   ...
   portPinConfig.mux = kPORT_MuxAlt7;
   portPinConfig.lockRegister = kPORT_UnlockRegister;
   PORT_SetPinConfig(PORTB, 1, &portPinConfig);
