...
#define APP_MAC_ADDR "00-AB-CD-EF-10-42"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::1042"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::1042"
...
void ioInit(void)
{
   ...
   //Configure GPIO_AD_B0_08 pin as GPIO1_IO08
...
int_t main(void)
{
   ...
   TRACE_INFO("Target: i.MX RT1042\r\n");
   TRACE_INFO("\r\n");

   //Configure I/Os
   ioInit();

   //Initialize FXLS8974CF sensor
   fxls8974cfInit();

   //Initialize hardware cryptographic accelerator
   error = mimxrt1040CryptoInit();
   //Any error to report?
   if(error)
   {
      //Debug message
   ...
   netSetDriver(interface, &mimxrt1040EthDriver);
