...
#define APP_MAC_ADDR "00-AB-CD-EF-65-18"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::6518"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::6518"
...
uint16_t adcGetValue(uint8_t channel)
{
   ...
   ADC16_SetChannelConfig(ADC1, 0, &adc16ChannelConfig);

   //Wait for the conversion to complete
   while((ADC16_GetChannelStatusFlags(ADC1, 0) &
