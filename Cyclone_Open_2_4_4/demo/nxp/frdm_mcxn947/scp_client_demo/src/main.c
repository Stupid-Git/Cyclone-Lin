...
#define APP_MAC_ADDR "00-AB-CD-EF-09-47"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::947"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::947"
...
void ioInit(void)
{
   ...
   //Configure PORT0_23 as PIO0_23
   PORT_SetPinConfig(PORT0, 23, &portPinConfig);
   ...
   //Configure SW2 and SW3 as inputs
...
void userTask(void *param)
{
   ...
   while(1)
   {
      ...
      if(!GPIO_PinRead(BOARD_SW3_GPIO, BOARD_SW3_GPIO_PIN))
      {
         ...
         while(!GPIO_PinRead(BOARD_SW3_GPIO, BOARD_SW3_GPIO_PIN));
      }
...
int_t main(void)
{
   ...
   netSetDriver(interface, &mcxn947EthDriver);
