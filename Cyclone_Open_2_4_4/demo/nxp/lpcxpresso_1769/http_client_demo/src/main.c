...
#define APP_MAC_ADDR "00-AB-CD-EF-17-69"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::1769"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::1769"
...
{
   //Configure red LED
   LED_R_FIOSET = LED_R_MASK;
   LED_R_FIODIR |= LED_R_MASK;

   //Configure green LED
   LED_G_FIOSET = LED_G_MASK;
   LED_G_FIODIR |= LED_G_MASK;

   //Configure blue LED
   LED_B_FIOSET = LED_B_MASK;
   LED_B_FIODIR |= LED_B_MASK;
...
void userTask(void *param)
{
   ...
   {
      //SW2 button pressed?
      if(!(SW2_FIOPIN & SW2_MASK))
      {
         //HTTP client test routine
         httpClientTest();

         //Wait for the button to be released
         while(!(SW2_FIOPIN & SW2_MASK));
      }
