...
#define APP_MAC_ADDR "00-AB-CD-EF-10-21"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::1021"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::1021"
...
void mpuConfig(void)
{
   ...
   MPU->RBAR = ARM_MPU_RBAR(7, 0x2021C000U);
...
void ioInit(void)
{
   ...
   //Configure GPIO_AD_B0_05 pin as GPIO1_IO05
   IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B0_05_GPIO1_IO05, 0);

   //Set GPIO_AD_B0_05 pad properties
...
int_t main(void)
{
   ...
   netSetDriver(interface, &mimxrt1020EthDriver);
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "MIMXRT1020-EVK");
   }
