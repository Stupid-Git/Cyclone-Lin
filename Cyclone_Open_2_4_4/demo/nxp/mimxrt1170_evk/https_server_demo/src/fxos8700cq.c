...
{ \
   ...
   pinConfig.direction = (a != 0) ? kGPIO_DigitalInput : kGPIO_DigitalOutput; \
   pinConfig.outputLogic = 0; \
   pinConfig.interruptMode = kGPIO_NoIntmode; \
   GPIO_PinInit(GPIO12, 5, &pinConfig); \
}
...
{ \
   ...
   pinConfig.outputLogic = 0; \
   pinConfig.interruptMode = kGPIO_NoIntmode; \
   GPIO_PinInit(GPIO12, 4, &pinConfig); \
}

#define SDA_IN() GPIO_ReadPadStatus(GPIO12, 4)
...
void i2cInit(void)
{
   ...
   //Configure GPIO_LPSR_05 pin as GPIO12_IO5
   IOMUXC_SetPinMux(IOMUXC_GPIO_LPSR_05_GPIO12_IO05, 0);

   //Set GPIO_LPSR_05 pad properties
   IOMUXC_SetPinConfig(IOMUXC_GPIO_LPSR_05_GPIO12_IO05,
   ...
   //Configure GPIO_LPSR_04 pin as GPIO12_IO4
   IOMUXC_SetPinMux(IOMUXC_GPIO_LPSR_04_GPIO12_IO04, 1);

   //Set GPIO_LPSR_04 pad properties
   IOMUXC_SetPinConfig(IOMUXC_GPIO_LPSR_04_GPIO12_IO04,
      IOMUXC_SW_PAD_CTL_PAD_DWP_LOCK(0) |
      IOMUXC_SW_PAD_CTL_PAD_DWP(0) |
      IOMUXC_SW_PAD_CTL_PAD_ODE(1) |
      IOMUXC_SW_PAD_CTL_PAD_PUS(1) |
