...
#define APP_MAC_ADDR "00-AB-CD-EF-01-48"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::148"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::148"
...
void ioInit(void)
{
   //Enable PORTC and PORTE peripheral clocks
...
int_t main(void)
{
   ...
   netSetDriver(interface, &s32k1EthDriver);

#if defined(USE_TJA1101)
   //Select the relevant PHY driver
   netSetPhyDriver(interface, &tja1101PhyDriver);
   //Set PHY address
   netSetPhyAddr(interface, 0);
#elif defined(USE_TJA1103)
   //Select the relevant PHY driver
   netSetPhyDriver(interface, &tja1103PhyDriver);
   //Set PHY address
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "S32K148-EVB-Q176");
   }
