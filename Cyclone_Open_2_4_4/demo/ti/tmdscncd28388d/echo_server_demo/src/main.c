...
#define APP_MAC_ADDR "00-AB-CD-EF-28-38"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::2838"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::2838"
...
int_t main(void)
{
   ...
   HWREG(NVIC_BASE + NVIC_O_AIRCR) = NVIC_AIRCR_VECTKEY | Interrupt_PriorityGrouping_3_5;
   ...
   TRACE_INFO("Target: TMS320F28388D\r\n");
   TRACE_INFO("\r\n");
   ...
   netSetDriver(interface, &f2838xEthDriver);
   netSetPhyDriver(interface, &dp83822PhyDriver);
