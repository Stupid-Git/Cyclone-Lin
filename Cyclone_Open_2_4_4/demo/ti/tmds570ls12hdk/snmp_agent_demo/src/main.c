...
#define APP_MAC_ADDR "00-AB-CD-EF-05-70"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::570"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::570"
...
void ioInit(void)
{
   //Configure LED1 (NHET1_27)
   HET1DIR_bit.HETDIR27 = 1;
   HET1DOUT_bit.HETDOUT27 = 0;

   //Configure LED2 (NHET1_5)
   HET1DIR_bit.HETDIR5 = 1;
   HET1DOUT_bit.HETDOUT5 = 0;

   //Configure LED3 (NHET1_17)
   HET1DIR_bit.HETDIR17 = 1;
   HET1DOUT_bit.HETDOUT17 = 0;

   //Configure LED4 (NHET1_31)
   HET1DIR_bit.HETDIR31 = 1;
   HET1DOUT_bit.HETDOUT31 = 0;

   //Configure LED5 (NHET1_0)
   HET1DIR_bit.HETDIR0 = 1;
   HET1DOUT_bit.HETDOUT0 = 0;

   //Configure LED6 (NHET1_25)
   HET1DIR_bit.HETDIR25 = 1;
   HET1DOUT_bit.HETDOUT25 = 0;

   //Configure LED7 (NHET1_18)
   HET1DIR_bit.HETDIR18 = 1;
   HET1DOUT_bit.HETDOUT18 = 0;

   //Configure LED8 (NHET1_29)
   HET1DIR_bit.HETDIR29 = 1;
   HET1DOUT_bit.HETDOUT29 = 0;
}


/**
 * @brief RTI interrupt service routine
 **/

__irq __arm void rtiIrqHandler(void)
{
...
void rtiInit(void)
{
   //Select RTI clock source (OSC)
   RCLKSRC_bit.RTI1SRC = 0;
   //Select prescaler (1:8)
   RCLKSRC_bit.RTI1DIV = 3;

   //Stop counters
   RTIGCTRL = 0;
   //Clear freerunning counter
   RTIFRC0  = 0;
   ...
   //Configure RTI interrupts
   RTIINTFLAG_bit.INT0 = 1;
   RTISETINTENA_bit.SETINT0 = 1;

   //Register RTI interrupt handler
   vimChannelMap(VIM_RTIC0, VIM_RTIC0, (t_isrFuncPTR) rtiIrqHandler);
   //Enable RTI interrupts
   vimEnableInterrupt(VIM_RTIC0, SYS_IRQ);
...
int_t main(void)
{
   ...
   TRACE_INFO("Target: TMS570LS1227\r\n");
   TRACE_INFO("\r\n");
   ...
   netSetDriver(interface, &tms570EthDriver);
