...
#define APP_MAC_ADDR "00-AB-CD-EF-00-57"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::57"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::57"
...
int_t main(void)
{
   ...
   netSetDriver(interface, &rm57EthDriver);
