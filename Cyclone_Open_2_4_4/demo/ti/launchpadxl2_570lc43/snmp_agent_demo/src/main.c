...
void ioInit(void)
{
   ...
   //Configure LED2 (B_6)
   GIOPDRB_bit.GIOPDR6 = 0;
   GIODIRB_bit.GIODIR6 = 1;

   //Configure LED3 (B_7)
   GIOPDRB_bit.GIOPDR7 = 0;
   GIODIRB_bit.GIODIR7 = 1;

   //Clear LEDs
   GIODOUTB_bit.GIODOUT6 = 0;
   GIODOUTB_bit.GIODOUT7 = 0;
}
...
int_t main(void)
{
   ...
   TRACE_INFO("Target: TMS570LC4357\r\n");
   TRACE_INFO("\r\n");
   ...
   netSetPhyDriver(interface, &dp83630PhyDriver);
