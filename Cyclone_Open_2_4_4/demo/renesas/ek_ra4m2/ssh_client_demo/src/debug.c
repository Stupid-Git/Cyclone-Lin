...
void debugInit(uint32_t baudrate)
{
   ...
   //Configure TXD0 (P1_1)
   R_PFS->PORT[1].PIN[1].PmnPFS = (4 << R_PFS_PORT_PIN_PmnPFS_PSEL_Pos) |
      R_PFS_PORT_PIN_PmnPFS_PMR_Msk | R_PFS_PORT_PIN_PmnPFS_PCR_Msk;

   //Configure RXD0 (P1_0)
   R_PFS->PORT[1].PIN[0].PmnPFS = (4 << R_PFS_PORT_PIN_PmnPFS_PSEL_Pos) |
      R_PFS_PORT_PIN_PmnPFS_PMR_Msk | R_PFS_PORT_PIN_PmnPFS_PCR_Msk;
   ...
   R_SCI0->SEMR = R_SCI0_SEMR_BGDM_Msk | R_SCI0_SEMR_ABCS_Msk;
   //Set baudrate
   R_SCI0->BRR = SystemCoreClock / (8 * baudrate) - 1;
