...
#define APP_MAC_ADDR "00-AB-CD-EF-00-72"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::72"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::72"
...
void mqttTestTask(void *param)
{
   ...
   while(1)
   {
      ...
      else
      {
         ...
         buttonState = !(S4_IOPORT->PCNTR2 & S4_MASK);
