...
void ACMPHS0_INT_IRQHandler               (void) __attribute__((weak, alias("Default_Handler")));
void ACMPHS1_INT_IRQHandler               (void) __attribute__((weak, alias("Default_Handler")));
void ACMPHS2_INT_IRQHandler               (void) __attribute__((weak, alias("Default_Handler")));
void ACMPHS3_INT_IRQHandler               (void) __attribute__((weak, alias("Default_Handler")));
void ACMPHS4_INT_IRQHandler               (void) __attribute__((weak, alias("Default_Handler")));
void ACMPHS5_INT_IRQHandler               (void) __attribute__((weak, alias("Default_Handler")));
