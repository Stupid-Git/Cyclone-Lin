...
#define APP_MAC_ADDR "00-AB-CD-EF-00-59"
...
#define APP_IPV6_LINK_LOCAL_ADDR "fe80::59"
#define APP_IPV6_PREFIX "2001:db8::"
#define APP_IPV6_PREFIX_LENGTH 64
#define APP_IPV6_GLOBAL_ADDR "2001:db8::59"
...
void ioInit(void)
{
   ...
   //Configure S4
   R_PFS->S4_PFS_b.ASEL = 0;
   R_PFS->S4_PFS_b.PMR = 0;
   R_PFS->S4_PFS_b.PDR = 0;

   //Configure S5
   R_PFS->S5_PFS_b.ASEL = 0;
...
int_t main(void)
{
   ...
   TRACE_INFO("Target: Synergy S5D9\r\n");
   TRACE_INFO("\r\n");
   ...
   netSetDriver(interface, &s5d9EthDriver);
   ...
   const char_t *param)
{
   ...
   {
      strcpy(connection->buffer, "PK-S5D9");
   }
