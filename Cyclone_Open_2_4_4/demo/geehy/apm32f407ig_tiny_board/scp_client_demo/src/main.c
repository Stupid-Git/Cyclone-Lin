...
void userTask(void *param)
{
   ...
   {
      //KEY1 button pressed?
      if(!GPIO_ReadInputBit(GPIOC, GPIO_PIN_10))
      {
         //SCP client test routine
         scpClientTest();

         //Wait for KEY1 button to be released
         while(!GPIO_ReadInputBit(GPIOC, GPIO_PIN_10));
      }
