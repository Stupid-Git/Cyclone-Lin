...
void ioInit(void)
{
   ...
   GPIO_InitStructure.Pin = WKUP_PIN;
   GPIO_InitStructure.Mode = GPIO_MODE_INPUT;
   GPIO_InitStructure.Pull = GPIO_PULLDOWN;
   GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_LOW;
   HAL_GPIO_Init(WKUP_GPIO, &GPIO_InitStructure);

   //Configure TAMPER button
   GPIO_InitStructure.Pin = TAMPER_PIN;
   GPIO_InitStructure.Mode = GPIO_MODE_INPUT;
   GPIO_InitStructure.Pull = GPIO_PULLUP;
   GPIO_InitStructure.Speed = GPIO_SPEED_FREQ_LOW;
   HAL_GPIO_Init(TAMPER_GPIO, &GPIO_InitStructure);
}
...
void userTask(void *param)
{
   ...
   {
      //WKUP button pressed?
      if(HAL_GPIO_ReadPin(WKUP_GPIO, WKUP_PIN))
      {
         //FTP client test routine
         ftpClientTest();

         //Wait for the WKUP button to be released
         while(HAL_GPIO_ReadPin(WKUP_GPIO, WKUP_PIN));
      }
