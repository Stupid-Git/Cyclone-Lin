 ...
 ** 2013-03-12 V1.1 Added Trace Buffer enable definition
 *****************************************************************************/

#ifndef _SYSTEM_MB9BFD1X_H_
#define _SYSTEM_MB9BFD1X_H_
...
/******************************************************************************/
  ...
  #if (CHECK_RSVD((PSW_TMR_Val),  ~0x00000017))
...
#if (CHECK_RSVD((APBC1_PSR_Val),  ~0x00000093))
  #error "APBC1_PSR: Invalid values of reserved bits!"
#endif

#if (CHECK_RSVD((APBC2_PSR_Val),  ~0x00000093))
...
#if (CHECK_RSVD((TTC_PSR_Val),    ~0x00000003))
